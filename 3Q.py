...
while True:
    ...
    if response.status_code == 200:
        ...
        for match in matches:
            ...
            # Only add to message if this match is in the 3rd quarter and the timer is between 24:00 and 26:00
        ...
        if printed_matches:
            ...
            print("No matches found within the 3rd quarter and the time range.")
