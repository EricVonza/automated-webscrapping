...
if response.status_code == 200:
    ...
    for match in matches:
        ...
        # Only print if this match has not been printed before, is in the 2nd quarter, and the timer is between 14:00 and 16:00
        if match_identifier not in printed_matches and quarter_text == "2nd quarter" and timer_text and is_timer_in_range(timer_text):
            ...
            # Print the relevant information for the 2nd quarter match with timer in range
            if teams_text:
